About opentelemetry-exporter-gcp-trace-feedstock
================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-exporter-gcp-trace-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-exporter-gcp-trace-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-exporter-gcp-trace
# for installing globally
pixi global install opentelemetry-exporter-gcp-trace
```
...
It is possible to list all of the versions of `opentelemetry-exporter-gcp-trace` available on your platform:
...
```
pixi search opentelemetry-exporter-gcp-trace --channel conda-forge
```
